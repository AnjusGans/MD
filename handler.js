                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            let wel = API('dhamz', '/api/canvas/welcome', {
                                pp: pp,
                                name: await this.getName(user),
                                bg: 'https://telegra.ph/file/2e33124e5fa0c5a1e0c6f.jpg',
                                grupname: await this.getName(id),
                                member: groupMetadata.participants.length
                            })
                            let lea = API('dhamz', '/api/canvas/goodbye', {
                                pp: pp,
                                name: await this.getName(user),
                                bg: 'https://telegra.ph/file/2e33124e5fa0c5a1e0c6f.jpg',
                                grupname: await this.getName(id),
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, wm, action === 'add' ? 'Welcome' : 'GoodBye', action === 'add' ? '.menu' : 'Welcome')
                        }
                    }
                }
                break
...
global.hentaigif = [
'https://cdn.donmai.us/original/f0/63/f063c294f6f64042a4202b308705450a.gif',
//'https://api-cdn.rule34.xxx/images/5430/908cc0d2dd694bd30a578a1ffaebf1dc.png',
'https://cdn.donmai.us/original/79/41/79413ca5d1b3e8de58e56029a26a148f.gif',
'https://cdn.donmai.us/original/a3/ac/a3ac1d0168fd5d6cddcf2ee7a14216de.gif'
]
