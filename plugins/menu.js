...
╰──────────────┈`
    const sections = [
      {
        ...
        rows: [
          ...
          { title: 'NSFW Menu️', rowId: `${_p}bebanortu` },
          { title: 'Internet Menu️', rowId: `${_p}internet` },
          { title: 'Anonymus Chat', rowId: `${_p}anonymous` },
          { title: 'Logo & Nulis Menu️', rowId: `${_p}nulis` },
          { title: 'Downloader Menu', rowId: `${_p}downloader` },
          { title: 'Tools️', rowId: `${_p}tools` },
          { title: 'Fun Menu', rowId: `${_p}fun`},
          { title: 'DataBase Menu', rowId: `${_p}database` },
          { title: 'Vote & Absen', rowId: `${_p}vote` },
          { title: 'AlQuran', rowId: `${_p}quran` },
    ...
    await conn.send3TemplateButtonImg(m.chat, fla + teks, text.trim(), wm, `Owner Bot`, `${_p}owner`, `TqTo`, `${_p}tqto`, `Profile User`, `${_p}profile`)
  } catch (e) {
